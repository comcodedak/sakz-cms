		...
		<div class="box-body table-responsive">
			...
			<form action="batch_update.do" method="post">
				...
				<div class="btn-toolbar ls-btn-bar">
					...
					<div class="btn-group">
						<shiro:hasPermission name="core:publish_point:batch_update">
				...
				<table id="pagedTable" class="table table-condensed table-bordered table-hover ls-tb form-inline">
				  ...
				  <tr class="ls_table_th">
				    ...
				    <th class="ls-th-sort"><span class="ls-sort" pagesort="description"><s:message code="publishPoint.description"/></span></th>
				    ...
				    <th class="ls-th-sort"><span class="ls-sort" pagesort="ftpHostname"><s:message code="publishPoint.ftpHostname"/></span></th>
				    <th class="ls-th-sort"><span class="ls-sort" pagesort="ftpPort"><s:message code="publishPoint.ftpPort"/></span></th>
				    <th class="ls-th-sort"><span class="ls-sort" pagesort="ftpUsername"><s:message code="publishPoint.ftpUsername"/></span></th>
				    <th class="ls-th-sort"><span class="ls-sort" pagesort="ftpPassword"><s:message code="publishPoint.ftpPassword"/></span></th>
				  ...
				  <tr beanid="${bean.id}">
				    ...
				    <td><f:text name="name" value="${bean.name}" style="width:120px;"/></span></td>
				    <td align="center"><f:text class="form-control input-sm" name="description" value="${bean.description}" style="width:100px;"/></td>
				    <td align="center"><f:text class="form-control input-sm" name="storePath" value="${bean.storePath}" style="width:100px;"/></td>
				    <td align="center"><f:text class="form-control input-sm" name="displayPath" value="${bean.displayPath}" style="width:100px;"/></td>
				    <td align="center"><f:text class="form-control input-sm" name="ftpHostname" value="${bean.ftpHostname}" style="width:100px;"/></td>
				    <td align="center"><f:text class="form-control input-sm" name="ftpPort" value="${bean.ftpPort}" style="width:100px;"/></td>
				    <td align="center"><f:text class="form-control input-sm" name="ftpUsername" value="${bean.ftpUsername}" style="width:100px;"/></td>
				    <td align="center"><f:text class="form-control input-sm" name="ftpPassword" value="${bean.ftpPassword}" style="width:100px;"/></td>
				    <td align="center"><f:text class="form-control input-sm" name="method" value="${bean.method}" style="width:100px;"/></td>
				  </tr>
				  </c:forEach>
				  </tbody>
				</table>
